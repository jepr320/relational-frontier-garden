...
The connection to Jake's work is direct and significant. Vervaeke has been in dialogue with Jake about the Relational Frontier and the retreat Jake is developing. From Vervaeke's perspective, what Jake does — facilitating genuine encounter, creating relational containers for transformation, using Circling and depth practices — is precisely the kind of "response to the meaning crisis" his framework calls for. The upcoming retreat is a potential site of genuine collaboration between these two perspectives.

Vervaeke is also notable for his engagement with Neoplatonism — particularly through James Filler's work on Neoplatonism and relation as ontological ground — and with figures like Zak Stein (on education and metatherapy) and Brendan Graham Dempsey (on the developmental arc of human consciousness). These conversations mark a growing intellectual community working on the same set of problems from adjacent angles.
